...
N_PARTICLE = 100  # number of particle --> maybe change this to num_lidar_samples
...
def observation(xTrue, xd, u, rfid):
    # calc true state
    xTrue = motion_model(xTrue, u) # replace with GPS -- do not need motion model
    ...
    xd = motion_model(xd, ud) # odometry
